...
//                    ^^^^^^^^^ reference scip-dotnet nuget System.Console 9.0.0.0 System/Console#WriteLine(+13).
//                                                       ^^^^^ reference local 14
//                                                               ^ reference local 15
          }
      }
...
//                                         ^ reference local 44
//                                             ^ reference local 39
//                                               ^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 System/Func#Invoke().
//                                                      ^ reference local 44
//                                                         ^ reference local 44
      }
...
//                           ^^^^^^^^^^^^^^^^^^^^^^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 System/ArgumentOutOfRangeException#
          };
      }
...
//              documentation ```cs\nbool a\n```
//                ^ reference local 78
//                         ^^^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 System/Int32#MaxValue.
          var d = s is nameof(a);
//            ^ definition local 82
//              documentation ```cs\nbool d\n```
//                ^ reference local 78
