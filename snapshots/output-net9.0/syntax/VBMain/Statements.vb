...
'                           documentation ```vb\nPrivate Sub Statements.Try()\n```
              Try
                  File.ReadLines("asd")
'                 ^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 IO/File#
'                      ^^^^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 IO/File#ReadLines().
              Catch err As Exception
'                   ^^^ definition local 0
'                       documentation ```vb\nerr As Class Exception\n```
'                   ^^^ reference local 0
'                          ^^^^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 System/Exception#
...
'                                                                ^^^^^ reference scip-dotnet nuget System.Linq 9.0.0.0 Linq/Enumerable#Where().
'                                                                               ^ definition local 7
...
'                            documentation ```vb\nClass MyDisposable\n```
'                            relationship implementation scip-dotnet nuget System.Runtime 9.0.0.0 System/IDisposable#
              Implements IDisposable
'                        ^^^^^^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 System/IDisposable#

              Private Sub Dispose() Implements IDisposable.Dispose
'                         ^^^^^^^ definition scip-dotnet nuget . . VBMain/Statements#MyDisposable#Dispose().
'                                 documentation ```vb\nPrivate Sub MyDisposable.Dispose()\n```
'                                 relationship implementation reference scip-dotnet nuget System.Runtime 9.0.0.0 System/IDisposable#Dispose().
'                                              ^^^^^^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 System/IDisposable#
'                                                          ^^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 System/IDisposable#Dispose().
...
'                   ^ definition local 14
'                     documentation ```vb\na As Class Stream\n```
'                        ^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 IO/Stream#
'                                 ^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 IO/File#
'                                      ^^^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 IO/File#OpenRead().
'                                                     ^ definition local 15
'                                                       documentation ```vb\nb As Class Stream\n```
'                                                          ^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 IO/Stream#
'                                                                   ^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 IO/File#
...
'                        ^ reference local 14
'                          ^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 IO/Stream#Length.
'                                   ^ reference local 15
'                                     ^^^^^^ reference scip-dotnet nuget System.Runtime 9.0.0.0 IO/Stream#Length.
              End Using
          End Function
