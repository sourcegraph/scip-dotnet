...
'                                         ^^^^^^^^^ reference scip-dotnet nuget System.Runtime 6.0.0.0 Collections/ArrayList#
...
'                                  ^^^ reference scip-dotnet nuget System.Runtime 6.0.0.0 Collections/ArrayList#Add().
...
'                 ^^^^^^^^^^^^^^^^ reference scip-dotnet nuget . . VBMain/Events#EventHandlerList.
'                                  ^^^^^^ reference scip-dotnet nuget System.Runtime 6.0.0.0 Collections/ArrayList#Remove().
...
'                                                        documentation ```vb\ne As EventArgs\n```
'                                                           ^^^^^^^^^ reference scip-dotnet nuget System.Runtime 6.0.0.0 System/EventArgs#
...
'                         ^^^^^^^ reference local 0
'                                 ^^^^^^^^^^^ reference scip-dotnet nuget System.Runtime 6.0.0.0 System/EventHandler#BeginInvoke().
