...
//                        documentation ```cs\nprivate System.Int32 Main.Methods.SingleParameter(System.Int32 b)\n```
...
//                      documentation ```cs\nprivate System.Int32 Main.Methods.TwoParameters(System.Int32 a, System.Int32 b)\n```
...
//                  documentation ```cs\nprivate System.Int32 Main.Methods.Overload1(System.Int32 a)\n```
...
//                  documentation ```cs\nprivate System.Int32 Main.Methods.Overload1(System.Int32 a, System.Int32 b)\n```
...
//              documentation ```cs\nprivate T Main.Methods.Generic<T>(T param)\n```
//                 ^ reference scip-dotnet nuget . . Main/Methods#Generic().[T]
...
//                        documentation ```cs\nprivate T Main.Methods.GenericConstraint<T>(T param) where T : new()\n```
//                           ^ reference scip-dotnet nuget . . Main/Methods#GenericConstraint().[T]
...
//                          documentation ```cs\nprivate void Main.Methods.DefaultParameter([System.Int32 a = 5])\n```
...
//                                 documentation ```cs\nprivate System.Int32 Main.Methods.DefaultParameterOverload([System.Int32 a = 5])\n```
...
//                                 documentation ```cs\nprivate System.Int32 Main.Methods.DefaultParameterOverload(System.Int32 a, System.Int32 b)\n```
...
//                     documentation ```cs\ninterface Main.Methods.IHello\n```
      {
          string Hello();
//               ^^^^^ definition scip-dotnet nuget . . Main/Methods#IHello#Hello().
//                     documentation ```cs\nSystem.String Main.Methods.IHello.Hello()\n```
      }
...
//                            documentation ```cs\nprivate System.String Main.Methods.ImplementsHello.Main.Methods.IHello.Hello()\n```
...
//                           documentation ```cs\npublic void Main.Methods.InheritedOverloads1.Method()\n```
          {
          }
      }
...
//                          documentation ```cs\npublic System.Int32 Main.Methods.InheritedOverloads2.Method(System.Int32 parameter)\n```
...
//                             documentation ```cs\npublic System.String Main.Methods.InheritedOverloads3.Method(System.String parameter)\n```
...
//                                          documentation ```cs\npublic static void Main.Methods.InheritedOverloads()\n```
      {
